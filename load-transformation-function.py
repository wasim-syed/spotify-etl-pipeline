        ...
        for key, value in row.items():
            if key == "track" :
                for artist in value['artists'] :
                    artist_dec = {'artist_id':artist['id'], 'artist_name' :artist['name'], 'external_url' :artist['href']}
                    artist_list.append(artist_dec)
    return artist_list
...
def lambda_handler(event, context):
    ...
    for data in spotify_data:
        ...
        album_df = album_df[album_df['release_date']!='2011']
